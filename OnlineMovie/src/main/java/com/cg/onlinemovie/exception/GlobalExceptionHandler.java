...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(OnlineMovieException.class)
	public @ResponseBody ResponseEntity<ErrorInfo>  handleException(OnlineMovieException ex,HttpServletRequest req)
	{
